...
public class DataParser {
    ...
    public List<Cashpoint> getData() throws IOException {
        BufferedReader br = new BufferedReader(new FileReader(dataFile));
        String headerLine = br.readLine();
        validateHeaders(dataHeaders, headerLine.split(","));
    ...
    private void validateHeaders(String[] origHeaders, String[] parsedHeaders) {
